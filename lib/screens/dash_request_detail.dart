...
class DashRequestDetailScreen extends StatefulWidget {
  final Request request;
  final dynamic userData;
  const DashRequestDetailScreen(
      {super.key, required this.request, required this.userData});

  @override
  _DashRequestDetailScreenState createState() => _DashRequestDetailScreenState();
}

class _DashRequestDetailScreenState extends State<DashRequestDetailScreen> {
